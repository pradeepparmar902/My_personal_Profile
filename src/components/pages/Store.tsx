                  ...
                  <div className="text-center py-8 px-4 space-y-4">
                    {selectedForm?.isPaused ? (
                      <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-8 relative overflow-hidden">
                        ...
                        <h3 className="text-3xl font-serif font-bold text-red-400 mb-4 relative z-10">
                          Registration Closed!
                        </h3>
                        <p className="text-red-200/90 text-sm md:text-base leading-relaxed max-w-sm mx-auto relative z-10 font-medium bg-red-950/40 p-4 rounded-xl border border-red-500/20">
                          {contactSuccessMsg}
                        </p>
                      </div>
                    ) : (
                      ...
                      <button
                        onClick={closeContactModal}
                        className="mt-6 px-6 py-2.5 rounded-full bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 transition-colors relative z-10"
                      >
                        Close Window
                      </button>
                  </div>
